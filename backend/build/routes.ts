...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        app.get('/datafiles',
            ...
            function BasicDatafileController_getAllDataFiles(request: any, response: any, next: any) {
            const args = {
            };
            ...
            try {
              ...
              const promise = controller.getAllDataFiles.apply(controller, validatedArgs as any);
        ...
        app.get('/datafiles/:fileId',
            ...
            try {
              ...
              const promise = controller.getDatafile.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
